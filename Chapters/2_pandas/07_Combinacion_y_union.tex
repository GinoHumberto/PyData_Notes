...
No siempre tendremos la suerte de que las columnas ``llave'' se llamen igual en ambas tablas. Para estos casos, en lugar de usar el parámetro \texttt{on}, le indicamos explícitamente a \textit{Pandas} qué columna mirar en la tabla de la izquierda (\texttt{left_on}) y cuál en la de la derecha (\texttt{right_on}).

\begin{pycode}{left_on, right_on}
import pandas as pd
